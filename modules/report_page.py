...
def indonesian_number_format(x):
    # Format numbers: 1.234.567,89 (Dua desimal)
    try:
...
def show_report_page():
    ...
    if st.button("Generate Laporan"):
        ...
        targets = [('penumpang_datang', 'Penumpang Datang'), ('penumpang_berangkat', 'Penumpang Berangkat')] if moda == 'Transportasi Udara' else [('dn_penumpang_turun', 'Penumpang Turun'), ('dn_penumpang_naik', 'Penumpang Naik')]
